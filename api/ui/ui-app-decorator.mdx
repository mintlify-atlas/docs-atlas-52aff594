...
<Note>
**@UIApp vs @GPTApp**: Use `@UIApp` for general MCP apps. For ChatGPT Apps with OpenAI-specific metadata (widget controls, CSP, invocation messages), use [@GPTApp](/api/ui/gpt-app-decorator).
</Note>
